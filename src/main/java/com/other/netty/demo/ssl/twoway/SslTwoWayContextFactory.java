...
public final class SslTwoWayContextFactory {
    ...
    public static SSLContext getServerContext(String pkPath, String caPath, String pwd) {
    ...
    public static SSLContext getClientContext(String pkPath, String caPath,String pwd) {
